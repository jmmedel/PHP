          ...
          while ($rowImg = mysqli_fetch_assoc($resultImg)) {
            ...
            echo "<div>";
              ...
              if ($rowImg['status'] == 0) {
                ...
                //Here I added a random string behind the image name, to make sure that the image gets a different name each time the browser loads it on the page. This is to help the image change when we delete/upload a new one.
