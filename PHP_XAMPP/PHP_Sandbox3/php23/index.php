<?php
  ...
  //We can also use the bellow code, if we want to make sure that we cannot add a specific file more than once. This helps avoid that we accidentically include the same code multiple times
