<?php
  ...
  //IMPORTANT SECURITY STEP (which I forgot in the video)
  //Here I check if there is any "../" in the file name included by the user. This we CANNOT allow in the file name, because the user could hack/delete other important files on our server!!!
